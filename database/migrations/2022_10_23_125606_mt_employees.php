...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mt_employees', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('employee_approval_line_id');
            $table->string('employee_identity_type', 10);
            ...
            $table->string('employee_place_of_birth', 50);
            ...
            $table->string('employee_marital_status', 10);
            $table->foreignUuid('department_id');
            $table->foreignUuid('position_id');
            $table->timestamp('employee_join_date');
            $table->timestamp('employee_end_date');
            $table->foreignUuid('status_id');
            $table->string('employee_path_img', 255);
            $table->string('employee_img', 50);
