...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tx_attendances', function (Blueprint $table) {
            ...
            $table->foreignUuid('location_id_check_out')->nullable();
            $table->string('attendance_location_name_check_out', 100)->nullable();
            $table->string('attendance_desc_check_out', 255)->nullable();
            $table->timestamp('attendance_date_check_out')->nullable();
            $table->string('attendance_long_check_out', 50)->nullable();
            $table->string('attendance_lat_check_out', 50)->nullable();
